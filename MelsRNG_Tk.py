...
canvas = Canvas(width=524, height=78, bg=GUI_COLOUR, highlightthickness=0)
...
random_numbers_label = Label(text="Your Numbers: ", font=("Arial", 12, "normal"))
...
final_numbers = Label(text=f"", font=("Arial", 18, "bold"))
...
num_amount_label = Label(text="How many numbers?", font=("Arial", 12, "normal"))
...
low_num_label = Label(text="Low Number?", font=("Arial", 12, "normal"))
...
high_num_label = Label(text="High Number?", font=("Arial", 12, "normal"))
high_num_label.config(padx=10, pady=10, background=GUI_COLOUR)
high_num_label.grid(column=2, row=3, sticky="w")

output_label = Label(text=f"", font=("Arial", 10, "normal"))
...
check_button = Checkbutton(text="Unique?", variable=checked_state, command=unique_check)
